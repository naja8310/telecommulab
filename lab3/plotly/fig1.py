...
#2d plot
fig = make_subplots(rows=1,cols=2,subplot_titles=['Original Image','FFT'])
...
fig1 = make_subplots(rows=1,cols=2,specs=[[{'type':'surface'},{'type':'surface'}]],subplot_titles=['Original Image','FFT'])
