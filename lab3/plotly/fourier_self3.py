...
fig = make_subplots(rows=1,cols=2,
                    subplot_titles=['Amplitude Spectrum','Surface View'],
                    specs=[[{'type':'heatmap'},{'type':'surface'}]])
fig.add_trace(go.Heatmap(z=fftshift_abs,colorscale='gray',showscale=False),row=1,col=1)
fig.add_trace(go.Surface(x=x,y=y,z=fftshift_abs,colorscale='gray',showscale=False),row=1,col=2)
