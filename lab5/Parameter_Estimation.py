...
import numpy as np
img = Image.open('/home/michael/Desktop/8884474174345.jpg') # image extension *.png,*.jpg
new_width  = 270
new_height = 480
...
mountain_r = rgb2gray(imread('output image name.png'))
#Plot
...
plt.show()
import cv2
img = cv2.imread('output image name.png',0)
arr = np.array(img)
...
plt.figure(3)
plt.plot(xl,p1_est+p2_est+p3_est+p4_est+p5_est, 'r--',linewidth=2.0)
